...
public final class Superstructure {
    ...
    public static void requestSwerveState(SwerveStates newState) {
        if (kSelectedSwerveState != newState) {
            ...
            Logger.recordOutput(
                    dashboardKey + "/PreviousSwerveState", kPreviousSwerveState.toString());
        }
    }
    ...
    public static void requestIntakeState(IntakeStates newState) {
        if (kSelectedIntakeState != newState) {
            ...
            Logger.recordOutput(
                    dashboardKey + "/PreviousIntakeState", kPreviousIntakeState.toString());
        }
    }
    ...
    public static final class SwerveTriggers {
        ...
        public static final Trigger kControlledDriving =
                swerveStateIs(SwerveStates.CONTROLLED_DRIVING);
        public static final Trigger kAutoAlign = swerveStateIs(SwerveStates.AUTO_ALIGN);
        public static final Trigger kIntakeAssistance =
                swerveStateIs(SwerveStates.INTAKE_ASSISTANCE);
