...
public class RobotPose {
    ...
    public void addOdometryMeasurement(
            double timestamp,
            Rotation2d rotation,
            SwerveModulePosition[] modulePoseModulePositions) {
    ...
    public void addQuestMeasurment(Pose2d questPose, double timestamp) {
        ...
        poseEstimator.addVisionMeasurement(
                questPose, timestamp, VecBuilder.fill(0.001, 0.001, 0.01));
    }
    ...
    public void log() {
        ...
        Logger.recordOutput(
                "Localization/Odometry/Robot", RobotPose.getInstance().getOdometryPose());
