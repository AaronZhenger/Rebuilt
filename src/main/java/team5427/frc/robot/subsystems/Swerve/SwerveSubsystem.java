...
public class SwerveSubsystem extends SubsystemBase
    ...
    private SwerveSubsystem(OdometryConsumer consumer) {
            ...
            case SIM:
                kDriveSimulation =
                        new SwerveDriveSimulation(
                                mapleSimConfig, new Pose2d(3, 3, Rotation2d.k180deg));
                swerveModules[SwerveUtil.kFrontLeftModuleIdx] =
                        new SwerveModule(
        ...
        setpoint =
                new SwerveSetpoint(
                        new ChassisSpeeds(0, 0, 0), targetModuleStates, driveFeedforwards);
        ...
        sysId =
                new SysIdRoutine(
                        new SysIdRoutine.Config(
                                ...
                                (state) ->
                                        Logger.recordOutput(
                                                "SysId/SwerveSysIdState", state.toString())),
    ...
    public void periodic() {
        ...
        setpoint =
                setpointGenerator.generateSetpoint(
                        setpoint, inputChassisSpeeds, Constants.kLoopSpeed);
        ...
        for (int i = 0; i < initialTimestampLength; i++) {
            SwerveModulePosition[] newModulePositions =
                    new SwerveModulePosition[modulePositions.length];
            ...
            for (int midx = 0; midx < modulePositions.length; midx++) {
                ...
                moduleDeltas[midx] =
                        new SwerveModulePosition(
                                newModulePositions[midx].distanceMeters
                                        - modulePositions[midx].distanceMeters,
